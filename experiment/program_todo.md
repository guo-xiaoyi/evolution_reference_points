 # Todo for the programs

 ## Program-wise
 1. Check `oTree` hub settings (for automatic implementation with Prolific)
...
5. Add a lottery review page before and after the spin.
 ## Design-wise
 1. Make sure the incentivization plan (and how we deal with unserious answers)
 2. The anti-AI tools for Prolific is limited (and we cannot do much about it). You have to think some other options.
 3. Settle the term for the lottery
 4. Settle the time gap
